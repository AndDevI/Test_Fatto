    ...
    <div class="bg-white p-8 rounded-xl shadow-xl w-full max-w-md">
        ...
        <form id="edit-form" method="POST">
            ...
            <div class="mb-6">
                ...
                <input min="0.01" step="0.01" type="number" id="edit-custo" name="custo" class="w-full border-2 border-gray-300 rounded-lg px-4 py-2 mt-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all" required>
            </div>
