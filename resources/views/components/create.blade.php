<div class="text-black fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 backdrop-blur-lg">
    <div class="bg-white p-8 rounded-xl shadow-xl w-full max-w-md">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-semibold text-gray-800">Criar Nova Tarefa</h2>
        ...
        <form id="createTaskForm" action="{{ route('tarefas.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nome" id="nome" class="w-full border-2 border-gray-300 rounded-lg px-4 py-2 mt-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all" required>
            </div>
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <input type="date" name="data_limite" id="data_limite" class="w-full border-2 border-gray-300 rounded-lg px-4 py-2 mt-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all" required>
            </div>
